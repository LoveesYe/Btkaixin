...
class panelPlugin:
    ...
    __api_root_url = 'http://server.fikkey.com'
    ...
    def install_sync(self,pluginInfo,get):
        if 'download' in pluginInfo['versions'][0]:
            ...
            public.downloadFile('http://server.fikkey.com/api/Pluginother/get_file?fname=' + pluginInfo['versions'][0]['download'],toFile)
    ...
    def set_pyenv(self,filename):
        ...
        temp_file = temp_file.replace('http://download.bt.cn/install/public.sh', 'http://server.fikkey.com/install/public.sh')
        env_path=['PATH=/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin:~/bin']
        rep_path=['PATH={}/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/sbin:~/bin'.format(env_py+":")]
